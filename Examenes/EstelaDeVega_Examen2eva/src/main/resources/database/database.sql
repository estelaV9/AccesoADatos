DROP
DATABASE IF EXISTS GestionVuelos;
CREATE
DATABASE  GestionVuelos;
USE
GestionVuelos;
...
CREATE TABLE Vuelos
(
    idvuelo       VARCHAR(10) PRIMARY KEY AUTO_INCREMENT,
    ...
    idcompañia    INTEGER,
    FOREIGN KEY (idcompañia) REFERENCES Compañias (idcompañia) ON DELETE CASCADE
);
...
-- ------------- LLENAR VUELOS: -------------------------------
INSERT INTO Vuelos
VALUES ('IB-SP-4567', '27/03/99-10:30', 'PARIS', 'MADRID', 20.99, 1, 1),
